...
- Once you have your `.npmrc` and before you run `npm install` command, replace all occurrences of `@cursospotiapp/jobber-shared` with your own shared library.
- After replacing all occurrences of `@cursospotiapp/jobber-shared`, you can then run `npm install` command.
